...
class Home extends Component {
  ...
  render () {
    ...
    const connectButton = <FlatButton key={0} onClick={this.connectApi.bind(this)} label={this.props.apiUrl || 'Connect'} />
    const mainButton = this.props.apiUrl
      ? <FlatButton key={1} onClick={this.createFile.bind(this)} label='Create' />
      : <div/>
    return (
      <MainLayout nav={<Nav title={'EV3.js'} iconRight={[mainButton, connectButton]}/>}>
