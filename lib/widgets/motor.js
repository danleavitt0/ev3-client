...
class Motor extends Component {
	...
	swapMode (e, i, item) {
		...
		this.interval = setInterval(() => this.props.dispatch(getSensorData(this.props.path, this.props.port, item.payload[0])), this.props.interval)
	}
	componentDidMount () {
		this.interval = setInterval(() => this.props.dispatch(getSensorData(this.props.path, this.props.port, 'position')), this.props.interval)
	}
